#+TODO: TODO | DONE
#+TITLE:     User Testing Requirements (clojure 1.10.3)
#+AUTHOR:    Keith D Houser
#+DESCRIPTION: kdh/stax requirements on Clojure 1.10.3
...
* User Testing Requirements (clojure 1.10.3)
...
CLOSED: [2022-07-29 Fri 12:47]

#+name: f-req-e-07
#+begin_src clojure :ns stax-user.core :results value pp :exports both
 ...
 ["defstackfn produced errors"
  {:error-data [["Global Operation Tree Errors: "
		 [{:op-type :kdh.stax.node/op=invoke,
		   ...
		   :fun +,
		   :arity 0,
		   :errors [{:err-zone :kdh.stax.errors/zone=tree,
			     :err-type :kdh.stax.errors/error=parse-invoke-arity-not-pos-int,
...
*** DONE COMMENT <<req-e-16>> *req-e-16*: defstackfn should provide an informative error if there's an invalid stack operation
CLOSED: [2022-07-29 Fri 13:03]
 ...
 ["defstackfn produced errors"
  {:error-data [["Global Operation Tree Errors: "
		 [{:op-type :kdh.stax.node/op=illegal,
		   :op else>,
		   :errors [{:err-zone :kdh.stax.errors/zone=tree,
			     :err-type :kdh.stax.errors/error=parse-illegal-operation,
...
(=> [3] )
#+end_src
*** DONE TODO <<req-i-02>> *req-i-02*: ~if>~ consumes the top of the stack
CLOSED: [2022-07-29 Fri 13:54]
...
#+begin_src clojure -n13 :exports code
(invoke> = 2) ; false
(if> ; stack empty
#+end_src
...
#+begin_src clojure -n18 :exports code
else>
 "false!!" ; "false!!"
    #+end_src
Therefore, I deduce an implicit requirement that ~if>~ first tests the top value and then pops it from the stack
*** DONE TODO <<req-i-03>> *req-i-03*: ~!v​+~ (define variable and assign it top of stack) does not consume the top of the stack
CLOSED: [2022-07-29 Fri 13:55]
...
+ push of value in stack variable ~!c~ would result in a stack of ~[4]~ if ~!v1+~ consumed to top, but the example shows:
  ...
  (invoke> = 2) ; false
  #+end_src
*** DONE TODO <<req-i-04>> *req-i-04*: ~(invoke> fun n)~ applies n items off the top of the stack in stack order (i.e. reverse of underlying vector's order)
CLOSED: [2022-07-29 Fri 13:56]
...
;;+> 4 3 2 1
#+end_src
*** DONE TODO <<req-i-05>> *req-i-05*: ~(invoke> fun n)~ for the sake of consistency, the return value of invoke should be /constant/ (i.e. self-evaluating)
CLOSED: [2022-07-29 Fri 14:00]
#+name: f-req-i-05
#+begin_src clojure
...
(=>
 ["Runtime Errors" {:error-text "\nRUNTIME ERRORS:\n\t`(invoke> vector 3)' at op[3] node[3]:\n\t\t `(apply #'clojure.core/vector (3 2 1))' => `[3 2 1]' with *stax-require-simple-stack-values* = true\n",
    ...
    #+end_src
*** DONE TODO <<req-i-06>> *req-i-06*: For the sake of consistency, values passed to the defstackfn defined function should be /constant/ (i.e. self-evaluating)
CLOSED: [2022-07-29 Fri 14:01]
#+name: f-req-i-06
#+begin_src clojure
...
#+end_src    
*** DONE TODO <<req-i-07>> *req-i-07*: ~kdh.stax.core/defstackfn~ creates a named function that returns the remaining stack as a vector
CLOSED: [2022-07-29 Fri 14:01]
...
| clojure.compile.path          | ​/mnt​/e​/Sync​/Clojure​/rpl​/stax-deploy​/doc​/user-testing​/stax-user-clj-1-10-3​/target​/classes                                        |
| clojure.debug                 | false                                                                                                                           |
| file.encoding                 | UTF-8                                                                                                                           |
| file.separator                | ​/                                                                                                                               |
...
| sun.java.command              | clojure.main -i ​/tmp​/form-init16744887307907667977.clj                                                                          |
| sun.java.launcher             | SUN​_STANDARD                                                                                                                    |
| sun.jnu.encoding              | UTF-8                                                                                                                           |
| sun.management.compiler       | HotSpot 64-Bit Tiered Compilers                                                                                                 |
| sun.os.patch.level            | unknown                                                                                                                         |
| user.dir                      | ​/mnt​/e​/Sync​/Clojure​/rpl​/stax-deploy​/doc​/user-testing​/stax-user-clj-1-10-3                                                       |
...
(let [java-class-path
  ...
  | ​/mnt​/e​/Sync​/Clojure​/rpl​/stax-deploy​/doc​/user-testing​/stax-user-clj-1-10-3​/test                                                     |
  | ​/mnt​/e​/Sync​/Clojure​/rpl​/stax-deploy​/doc​/user-testing​/stax-user-clj-1-10-3​/src                                                      |
  | ​/mnt​/e​/Sync​/Clojure​/rpl​/stax-deploy​/doc​/user-testing​/stax-user-clj-1-10-3​/dev-resources                                            |
  | ​/mnt​/e​/Sync​/Clojure​/rpl​/stax-deploy​/doc​/user-testing​/stax-user-clj-1-10-3​/resources                                                |
  | ​/mnt​/e​/Sync​/Clojure​/rpl​/stax-deploy​/doc​/user-testing​/stax-user-clj-1-10-3​/target​/classes                                           |
  ...
  | ​/home​/keith​/.m2​/repository​/org​/clojure​/clojure​/1.10.3​/clojure-1.10.3.jar                                                           |
  ...
  | ​/home​/keith​/.m2​/repository​/org​/clojure​/spec.alpha​/0.2.194​/spec.alpha-0.2.194.jar                                                   |
  ...
  | ​/home​/keith​/.m2​/repository​/org​/clojure​/core.specs.alpha​/0.2.56​/core.specs.alpha-0.2.56.jar                                         |
